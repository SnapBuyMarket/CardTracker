...
while True:
    for filename in os.listdir(incoming_dir):
        ...
        if filename.endswith(".jpg") or filename.endswith(".jpeg"):  # Process image files
            ...
            # First, move the file to the Processing folder
